...
These benchmarks are used as part of [our paper]() on the [Parasol compiler](https://docs.sunscreen.tech/). We ran the benchmarks on an AWS c7a.16xlarge instance.
